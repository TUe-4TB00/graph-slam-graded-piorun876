...
def optimize(graph, initial_estimate):
    ...
    params = gtsam.LevenbergMarquardtParams() # pyright: ignore[reportAttributeAccessIssue]
    optimizer = gtsam.LevenbergMarquardtOptimizer(graph, initial_estimate, params) # pyright: ignore[reportAttributeAccessIssue]
...
def minimize_marginals(graph, initial_estimate, pose_options):
    ...
    # marginals = []
    marginals = gtsam.Marginals(graph, result) # pyright: ignore[reportAttributeAccessIssue]
